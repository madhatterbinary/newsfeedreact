...
Object.defineProperty(exports, 'fetchFeedStart', {
				enumerable: true,
				get: function get() {
								return _feed.fetchFeedStart;
				}
});
Object.defineProperty(exports, 'fetchFeedsSuccess', {
				enumerable: true,
				get: function get() {
								return _feed.fetchFeedsSuccess;
				}
});
Object.defineProperty(exports, 'fetchFeedsFail', {
				enumerable: true,
				get: function get() {
								return _feed.fetchFeedsFail;
				}
});
Object.defineProperty(exports, 'fetchFeeds', {
				enumerable: true,
				get: function get() {
								return _feed.fetchFeeds;
				}
});
Object.defineProperty(exports, 'addFeed', {
				enumerable: true,
				get: function get() {
								return _feed.addFeed;
				}
});
Object.defineProperty(exports, 'addFeedSuccess', {
				enumerable: true,
				get: function get() {
								return _feed.addFeedSuccess;
				}
});
Object.defineProperty(exports, 'addFeedFail', {
				enumerable: true,
				get: function get() {
								return _feed.addFeedFail;
				}
});
Object.defineProperty(exports, 'deleteFeed', {
				enumerable: true,
				get: function get() {
								return _feed.deleteFeed;
				}
});
Object.defineProperty(exports, 'deleteFeedSuccess', {
				enumerable: true,
				get: function get() {
								return _feed.deleteFeedSuccess;
				}
});
Object.defineProperty(exports, 'selectedFeed', {
				enumerable: true,
				get: function get() {
								return _feed.selectedFeed;
				}
});
Object.defineProperty(exports, 'getFeedLink', {
				enumerable: true,
				get: function get() {
								return _feed.getFeedLink;
				}
});
Object.defineProperty(exports, 'getFeedLinkSuccess', {
				enumerable: true,
				get: function get() {
								return _feed.getFeedLinkSuccess;
				}
});
...
var ADD_FEED = exports.ADD_FEED = 'ADD_FEED';
var ADD_FEED_SUCCESS = exports.ADD_FEED_SUCCESS = 'ADD_FEED_SUCCESS';
var ADD_FEED_FAIL = exports.ADD_FEED_FAIL = 'ADD_FEED_FAIL';
var FETCH_FEED_START = exports.FETCH_FEED_START = 'FETCH_FEED_START';
var FETCH_FEEDS_SUCCESS = exports.FETCH_FEEDS_SUCCESS = 'FETCH_FEEDS_SUCCESS';
var FETCH_FEEDS_FAIL = exports.FETCH_FEEDS_FAIL = 'FETCH_FEEDS_FAIL';
var DELETE_FEED = exports.DELETE_FEED = 'DELETE_FEED';
var DELETE_FEED_SUCCESS = exports.DELETE_FEED_SUCCESS = 'DELETE_FEED_SUCCESS';
var DELETE_FEED_FAIL = exports.DELETE_FEED_FAIL = 'DELETE_FEED_FAIL';
var SELECT_FEED = exports.SELECT_FEED = 'SELECT_FEED';
var GET_FEED_LINK = exports.GET_FEED_LINK = 'GET_FEED_LINK';
var GET_FEED_LINK_SUCCESS = exports.GET_FEED_LINK_SUCCESS = 'GET_FEED_LINK_SUCCESS';
var GET_FEED_LINK_FAIL = exports.GET_FEED_LINK_FAIL = 'GET_FEED_LINK_FAIL';
...
var app = _react2.default.createElement(
    ...
    { store: _store2.default.configure(null) },
...
var _Feeds = __webpack_require__(53);
...
var _Feed = __webpack_require__(102);
...
var Feeds = function (_Component) {
    ...
    function Feeds() {
        ...
        var _this = _possibleConstructorReturn(this, (Feeds.__proto__ || Object.getPrototypeOf(Feeds)).call(this));
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.props.feeds.map(function (feed, i) {
                            var color = feed === _this2.props.selected ? 'red' : '#333';
                            return _react2.default.createElement(
                                'li',
                                { className: 'feed-item', key: i },
                                _react2.default.createElement(
                                    'a',
                                    { style: { color: color }, onClick: _this2.selectFeed.bind(_this2, feed), href: '#', name: feed.url },
                                    feed.name
                                ),
                                _react2.default.createElement(
                                    'button',
                                    { type: 'button', className: 'btn btn-danger', onClick: _this2.delete.bind(_this2, feed) },
                                    'delete'
                                )
                            );
                        })
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    ...
    return {
        onFetchFeeds: function onFetchFeeds(feeds) {
            return dispatch(actions.fetchFeeds(feeds));
        },
        onFeedDeleted: function onFeedDeleted(id, feeds) {
            return dispatch(actions.deleteFeed(id, feeds));
        },
        onSelectedFeed: function onSelectedFeed(feed) {
            return dispatch(actions.selectedFeed(feed));
        },
        onGetFeedLink: function onGetFeedLink(feedLink) {
            return dispatch(actions.getFeedLink(feedLink));
        }

    };
};
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Feeds);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(27), __webpack_require__(72)(module)))
...
exports.fetchFeeds = exports.getFeedLinkSuccess = exports.getFeedLink = exports.selectedFeed = exports.getFeedLinkFail = exports.addFeedFail = exports.addFeedSuccess = exports.deleteFeedSuccess = exports.deleteFeed = exports.addFeed = exports.fetchFeedsFail = exports.fetchFeedsSuccess = exports.fetchFeedStart = undefined;

var _axiosFeeds = __webpack_require__(82);

var _axiosFeeds2 = _interopRequireDefault(_axiosFeeds);
...
var fetchFeedStart = exports.fetchFeedStart = function fetchFeedStart() {
...
var fetchFeedsSuccess = exports.fetchFeedsSuccess = function fetchFeedsSuccess(feeds) {
...
var fetchFeedsFail = exports.fetchFeedsFail = function fetchFeedsFail(error) {
	return {
		type: actionTypes.FETCH_FEEDS_FAIL,
		error: error
	};
};
var addFeed = exports.addFeed = function addFeed(feeds, feed) {
	return function (dispatch) {
		_axiosFeeds2.default.post('/feeds.json', feed).then(function (response) {
...
var deleteFeed = exports.deleteFeed = function deleteFeed(id, feeds) {
	return function (dispatch) {
		_axiosFeeds2.default.get('/feeds.json?orderBy="name"&equalTo="' + id.name + '"').then(function (response) {
			for (var key in response.data) {
				_axiosFeeds2.default.delete('/feeds/' + key + '.json').then(function (response) {
					dispatch(deleteFeedSuccess(id, feeds));
					_axiosFeeds2.default.get('/feeds.json').then(function (response) {});
				});
			}
		}).catch(function (error) {
...
var deleteFeedSuccess = exports.deleteFeedSuccess = function deleteFeedSuccess(id, feeds) {
	return {
...
var addFeedSuccess = exports.addFeedSuccess = function addFeedSuccess(feeds, feed) {
	return {
...
var addFeedFail = exports.addFeedFail = function addFeedFail(error) {
	return {
		type: actionTypes.ADD_FEED_FAIL,
		error: error
	};
};
var getFeedLinkFail = exports.getFeedLinkFail = function getFeedLinkFail(error) {
	return {
...
var selectedFeed = exports.selectedFeed = function selectedFeed(feed) {
	return {
		type: actionTypes.SELECT_FEED,
		selected: feed
	};
};
var getFeedLink = exports.getFeedLink = function getFeedLink(feedLink) {
	return function (dispatch) {
		var feedjson = [];
		_axios2.default.get('https://api.rss2json.com/v1/api.json?rss_url=' + feedLink).then(function (response) {
...
var getFeedLinkSuccess = exports.getFeedLinkSuccess = function getFeedLinkSuccess(feedjson) {
...
var fetchFeeds = exports.fetchFeeds = function fetchFeeds() {
	return function (dispatch) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    ...
    return {
        onAddFeed: function onAddFeed(feeds, feed) {
            return dispatch(actions.addFeed(feeds, feed));
        }
    };
};
...
var Feed = function (_Component) {
    ...
    _createClass(Feed, [{
        ...
        value: function render() {
            ...
            var name = selectedFeed ? selectedFeed.name : 'Welcome to Ulysses News Feeds';
            var title = this.props.title ? this.props.title : 'Select a feed to the left to display here';
            var description = this.props.description ? this.props.description : 'Your feed content will show here after you select a feed to the left.';
            return _react2.default.createElement(
                'div',
                { id: 'main' },
                _react2.default.createElement(
...
var _feedReducer = __webpack_require__(106);

Object.defineProperty(exports, 'feedReducer', {
    enumerable: true,
    get: function get() {
        return _feedReducer.feedReducer;
    }
});
...
exports.feedReducer = exports.getFeedLinkSuccess = exports.selectedFeed = exports.deleteFeedSuccess = exports.addFeedFail = exports.addFeedSuccess = exports.addFeed = exports.fetchFeeds = exports.fetchFeedsFail = exports.fetchFeedsSuccess = exports.fetchFeedStart = undefined;

var _actionTypes = __webpack_require__(38);

var actionTypes = _interopRequireWildcard(_actionTypes);

var _utility = __webpack_require__(107);
...
var fetchFeedStart = exports.fetchFeedStart = function fetchFeedStart(state, action) {
	return (0, _utility.updateObject)(state, { loading: true });
};

var fetchFeedsSuccess = exports.fetchFeedsSuccess = function fetchFeedsSuccess(state, action) {
	return (0, _utility.updateObject)(state, {
		feeds: action.feeds
	});
};

var fetchFeedsFail = exports.fetchFeedsFail = function fetchFeedsFail(state, action) {
	return (0, _utility.updateObject)(state, { loading: false });
};
var fetchFeeds = exports.fetchFeeds = function fetchFeeds(state, action) {
	return (0, _utility.updateObject)(state, action.feeds);
};
var addFeed = exports.addFeed = function addFeed(state, action) {
	return (0, _utility.updateObject)(state, action.feed);
};
var addFeedSuccess = exports.addFeedSuccess = function addFeedSuccess(state, action) {
	var newFeed = (0, _utility.updateObject)(state, action.feed);
...
var addFeedFail = exports.addFeedFail = function addFeedFail(state, action) {
	return (0, _utility.updateObject)(state, { loading: false });
};

var deleteFeedSuccess = exports.deleteFeedSuccess = function deleteFeedSuccess(state, action) {

	var newFeeds = action.feedsToUpdate.filter(function (feed) {
		return feed !== action.feedId;
	});
	return (0, _utility.updateObject)(state, { feeds: newFeeds });
};

var selectedFeed = exports.selectedFeed = function selectedFeed(state, action) {
	return (0, _utility.updateObject)(state, { selected: action.selected });
};

var getFeedLinkSuccess = exports.getFeedLinkSuccess = function getFeedLinkSuccess(state, action) {
	return (0, _utility.updateObject)(state, {
		title: action.title,
...
var feedReducer = exports.feedReducer = function feedReducer() {
	...
	switch (action.type) {
		...
		case actionTypes.FETCH_FEEDS_FAIL:
			return fetchFeedsFail(state, action);
		case actionTypes.ADD_FEED:
			return addFeed(state, action);
		case actionTypes.ADD_FEED_SUCCESS:
			return addFeedSuccess(state, action);
		case actionTypes.ADD_FEED_FAIL:
			return addFeedFail(state, action);
		case actionTypes.DELETE_FEED_SUCCESS:
			return deleteFeedSuccess(state, action);
		case actionTypes.SELECT_FEED:
			return selectedFeed(state, action);
		case actionTypes.GET_FEED_LINK_SUCCESS:
			return getFeedLinkSuccess(state, action);
